...
urlpatterns = [
    ...
    path('ajax_chat/',include([
        path('free', views.ajax_chat_free, name='ajax_chat_free'),  # 菲菲聊天API接口
        path('xiaoi', views.ajax_chat_xiaoi, name='ajax_chat_xiaoi'),  # 小艾聊天API接口
        path('dandan', views.ajax_chat_dandan, name='ajax_chat_dandan'),  # 蛋蛋聊天API接口
    ])),#二级路由
